-- =======================================================
-- SEED DATA FOR LOCAL POSTGRES MIS SCHEMA
-- =======================================================
...
values
  ('854ebeb9-12fa-476e-baa3-88dbbe492d56', 'saroj@example.com', 'Saroj Phalke', 'operator'),
  ('887f3d18-4927-4d41-8d4b-566efbdc3a30', 'tanushri@example.com', 'Tanushri Engineer', 'engineer'),
  ('51b21474-4946-44ce-b8ff-5eac106f70d7', 'saroj.admin@example.com', 'Saroj Admin', 'admin');
...
-- ASSET QR CODES
-- =======================================================
insert into public.asset_qr (asset_id, qr_payload)
values
  (1, 'QR-AST-001'),
  (2, 'QR-AST-002');
